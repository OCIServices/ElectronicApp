    ...
    <form id="form1" runat="server">
     <div id="FormContainer">
        <div id="FormTop"><h1 id="header" runat = "server"><span class="red">Welcome</span> </h1></div>
           <div id="FormMid"> 
           <p>Welcome to your Online Health Insurance Enrollment.  By using an online enrollment process we will be able to quickly submit your applications to multiple insurance companies to recieve quotes without you needing to fill out multiple applications.
               </p>
                 <br />
