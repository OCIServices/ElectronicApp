...
function save(){
	...
	with(JSD_CONTROL){
	    ...
	    if(!(LogX[0] == undefined || LogY[0] == undefined))
	    {
    ...
    */
	...
	mousemove : function (e,obj){
		with(obj){
			...
			if(this.mdown){
			if(!(nowX >= getQueryVariable("CanvasW") - 5 || nowX <= 3 || nowY >= getQueryVariable("CanvasH") - 5 || nowY <= 3))
			{
...
window.onload = function(){
	...
	with(JSD_CONTROL){
		...
		//addEvent(document.getElementsById('sign') ,'mouseleave',  function(e){mouseup(e,JSD_CONTROL)})
