<%@ Page Language="C#" Theme="FormPage" AutoEventWireup="true" CodeBehind="ReasonForDeclineDental.aspx.cs" Inherits="ElectronicApp.NebraskaApp.ReasonForDeclineDental" %>
...
<body>
    <form id="form1" runat="server">
       <div id="FormContainer">
        <div id="FormTop"><h1><span class="red">Reason</span> For Declining Dental Coverage</h1>
            <p>&nbsp;</p></div>
           <div id="FormMid">
               ...
               <table style="width: 100%; margin-left: 30px; margin-bottom: 32px;">
                   ...
                   <tr id="trDental" runat="server">
                       <td class="style5">
                           <asp:Label ID="Label4" runat="server" Text="Dental:" CssClass="lblBold"></asp:Label>
                           </td>
