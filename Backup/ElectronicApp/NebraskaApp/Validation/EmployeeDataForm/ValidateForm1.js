...
function validateNoWaive() {
    ...
    if (!validateHeight(document.getElementById("UserWizard1_txtHeight").value)) {
        //alert("Please enter your Height (ex. 5\'8\")");
        insertErrorRight("Please enter your Height (ex. 5\'8\")");
        rval = false;
    }
    ...
    if ( !validateRequired(document.getElementById("UserWizard1_txtHireDate").value)) {
       // alert("Please select an employment status.");
        insertErrorRight("Please enter date of hire.");
        rval = false;
    }
