               ...
               <table style="width: 717px; margin-left: 40px; margin-top: 4px;" 
                   ...
                   <tr>
                       ...
                       <td class="style9" valign="top">
                           <asp:Label ID="Label4" runat="server" Text="Have you or any person named in this application recieved inpatient or outpatient services in the last three (3) years (excluding routine tests, physicals or innoculations)?"></asp:Label>
                       </td>
                   </tr>
                   <tr>
