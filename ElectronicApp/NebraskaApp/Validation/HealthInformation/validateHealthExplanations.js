function valSubmit() {
    ...
    for ( i = 0; i < numBoxes.length; i++ ){
        ...
        else if ( diagTest.test(allBoxes[ numBoxes[ i ] ].name ) && !validateDate(allBoxes[ numBoxes[ i ] ].value) ) {
        ...
        else if ( tretTest.test(allBoxes[ numBoxes[ i ] ].name ) && !validateDate(allBoxes[ numBoxes[ i ] ].value) ) {
