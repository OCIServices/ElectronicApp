<%@ Page Language="C#" Theme="FormPage" AutoEventWireup="true" CodeBehind="ReasonForDeclineLife.aspx.cs" Inherits="ElectronicApp.NebraskaApp.ReasonForDeclineLife" %>
...
<body>
    <form id="form1" runat="server">
       <div id="FormContainer">
        <div id="FormTop"><h1><span class="red">Reason</span> For Declining Life Coverage</h1>
            <p>&nbsp;</p></div>
           <div id="FormMid">
               ...
               <table style="width: 100%; margin-left: 30px; margin-bottom: 32px;">
                   ...
                   <tr id="trMedical" runat="server">
                       <td class="style6">
                           <asp:Label ID="Label3" runat="server" Text="Life:" CssClass="lblBold"></asp:Label>
                           </td>
