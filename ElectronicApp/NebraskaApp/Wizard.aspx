...
<head id="Head1" runat="server">
    <title>i-Enroll :: Basic Information</title>
    <style type="text/css">
        ...
        <div id="FormContainer">
           ...
           <div id="FormMid">
                        <asp:Wizard id="UserWizard1" 
                            ...
                            DisplaySideBar="False" FinishDestinationPageUrl="~/NebraskaApp/SignApplication.aspx"
                            ...
                            StepPreviousButtonStyle-CssClass="buttons" 
                             ActiveStepIndex="0" FinishPreviousButtonStyle-CssClass="buttons" 
                            FinishCompleteButtonText="Next">
...
<FinishPreviousButtonStyle CssClass="buttons"></FinishPreviousButtonStyle>
                            <wizardsteps>
                                ...
                                <asp:WizardStep ID="WizardStep1" AllowReturn="false" StepType="Start" title="Basic Information" runat="server">
                                <!--Start Basic Info-->
                                ...
                                <asp:WizardStep ID="WizardStep2" title="Employee Data" runat="server">
                                    ...
                                    <table style="width: 100%; height: 67px; margin-left: 0px; margin-right: 0px; border-collapse: separate;">
	                                    ...
	                                    <tr>
		                                    ...
		                                    <td class="style6">
			                                    <asp:TextBox ID="txtHeight" runat="server" ValidationGroup="EmployeeData" Width="40px" TabIndex="12"></asp:TextBox> ft
			                                    <asp:TextBox ID="txtHeightin" runat="server" ValidationGroup="EmployeeData" Width="40px" TabIndex="12"></asp:TextBox> in
		                                    </td>
                                ...
                                <asp:WizardStep ID="WizardStep3" title="Coverage Selection" runat="server">
                                ...
                                <asp:WizardStep ID="WizardStep4" title="Dependent Data" runat="server">
                                <!--Start Dependent Data-->
                                    ...
                                    <table id ="dependents" style="margin-left: -10px;width:765px;">
                                       <tr>
	                                       <td class="style75">
	                                       ...
	                                       <td class="style89" style="width:60px;" colspan="2">
                                       ...
                                       <tr id="trSpouseTitle" runat="server">
	                                    ...
	                                    <tr id="trSpouse" runat="server">
		                                    ...
		                                    <td class="style89" style="width:30px;">
			                                    <asp:TextBox ID="spHeight" runat="server"  Height="17px" 
				                                    Width="15px"></asp:TextBox>ft
				                                    </td>
		                                    <td class="style89" style="width:30px;">
		                                    <asp:TextBox ID="spHeightin" runat="server"  Height="17px" Width="15px"></asp:TextBox>in
		                                    </td>
		                                    <td class="style87">
			                                    <asp:TextBox ID="spWeight" runat="server"  Height="17px" 
				                                    Width="35px" style="margin-right: 5px"></asp:TextBox></td>
		                                    <td class="style82">
	                                    ...
	                                    <tr id="trChildOne" runat="server">
		                                    ...
		                                    <td class="style89" style="width:30px";>
			                                    <%-- <asp:TextBox ID="ch1Height" runat="server"  Height="17px"
				                                    Width="15px" style="margin-right: 0px"></asp:TextBox> --%>
			                                    <asp:TextBox runat="server" Height="17px" Width="15px" ID="ch1Height" 
                                                    style="margin-right: 0px"></asp:TextBox>
                                                ft
		                                    </td>
		                                        <td class="style89" style="width:30px;">
			                                    <asp:TextBox ID="ch1Heightin" runat="server"  Height="17px" 
				                                    Width="15px" style="margin-right: 0px"></asp:TextBox>
	                                    ...
	                                    <tr id="trChildTwo" runat="server">
		                                    ...
		                                    <td class="style89" style="width:30px;">
		                                        ...
		                                        <td class="style89" style="width:30px;">
			                                    <asp:TextBox ID="ch2Heightin" runat="server"  Height="17px" 
				                                    Width="15px" style="margin-right: 0px"></asp:TextBox>
                                                    in
		                                    </td>
		                                    <td class="style87">
	                                    ...
	                                    <tr id="trChildThree" runat="server">
		                                   ...
		                                   <td class="style89" style="width:30px;">
                                               ...
                                               ft
		                                        ...
		                                        <td class="style89" style="width:30px;">
			                                    <asp:TextBox ID="ch3Heightin" runat="server"  Height="17px" 
				                                    Width="15px" style="margin-right: 0px"></asp:TextBox>
                                                    in
		                                    </td>
		                                    <td class="style87">
	                                    ...
	                                    <tr id="trChildFour" runat="server">
		                                    ...
		                                    <td class="style89" style="width:30px;">
		                                        ...
		                                        <td class="style89" style="width:30px;">
			                                    <asp:TextBox ID="ch4Heightin" runat="server"  Height="17px" 
				                                    Width="15px" style="margin-right: 0px"></asp:TextBox>
                                                    in
		                                    </td>
		                                    <td class="style87">
	                                    ...
	                                    <tr id="trChildFive" runat="server">
		                                    ...
		                                    <td class="style89" style="width:30px;">
		                                        ...
		                                        <td class="style89" style="width:30px;">
			                                    <asp:TextBox ID="ch5Heightin" runat="server"  Height="17px" 
				                                    Width="15px" style="margin-right: 0px"></asp:TextBox>
                                                    in
		                                    </td>
		                                    <td class="style87">
                                ...
                                <asp:WizardStep ID="WizardStep5" title="Reasons for Declining Medical Coverage" runat="server">
                                ...
                                <asp:WizardStep ID="WizardStep6" title="Reasons for Declining Dental Coverage" runat="server">
                                ...
                                <asp:WizardStep ID="WizardStep7" title="Reasons for Declining Vision Coverage" runat="server">
                                ...
                                <asp:WizardStep ID="WizardStep8" title="Reasons for Declining Life Coverage" runat="server">
                                <!--Start Decline Life-->
                                    <script language="javascript" type="text/javascript" src="Validation/DecliningForm/ValidateDecliningCoverage.js"></script>
                                    <script language="javascript" type="text/javascript" src="Validation/validationHelpers.js"></script>
                                    <style type="text/css">
                                ...
                                <asp:WizardStep ID="WizardStep9" title="Reasons for Declining Disability Coverage" runat="server">
                                ...
                                <asp:WizardStep ID="WizardStep10" title="Other Coverage" runat="server" >
                                ...
                                <asp:WizardStep ID="WizardStep11" title="Health Information" runat="server">
	                                       ...
	                                       <tr>
		                                       <td class="style1" colspan="2">
			                                       <asp:CheckBoxList ID="CheckBoxList1" runat="server" Width="363px" 
				                                       ...
				                                       <asp:ListItem>11. Physical Deformity or Defect</asp:ListItem>
				                                       <asp:ListItem>12. Digestive/Intestinal Disorder</asp:ListItem>
				                                       <asp:ListItem>13. Drug or Alcohol Abuse</asp:ListItem>
				                                       <asp:ListItem>14. Eating Disorder</asp:ListItem>
				                                       <asp:ListItem>15. Endocrine/Pancreatic Disorder</asp:ListItem>
				                                       <asp:ListItem>16. Eye, Ear, Nose, Throat Disorder (Excluding glasses)</asp:ListItem>
			                                       </asp:CheckBoxList>
		                                       </td>
		                                       ...
		                                       <td class="style2">
			                                       <asp:CheckBoxList ID="CheckBoxList3" runat="server" CellPadding="2" 
				                                       ...
				                                       <asp:ListItem>17. Heart/Circulatory Disorder</asp:ListItem>
				                                       <asp:ListItem>18. High Blood Pressure</asp:ListItem>
				                                       <asp:ListItem>19. High Cholesterol</asp:ListItem>
				                                       <asp:ListItem>20. Infertility</asp:ListItem>
				                                       <asp:ListItem>21. Kidney Disorder (dialysis or failure)</asp:ListItem>
				                                       <asp:ListItem>22. Liver (cirrhosis, hepatitis B, C, D or E</asp:ListItem>
				                                       <asp:ListItem>23. Mental or Nervous Disorder</asp:ListItem>
				                                       <asp:ListItem>24. Migraine Headaches</asp:ListItem>
				                                       <asp:ListItem>25. Neck, Back or Spine Disorder</asp:ListItem>
				                                       <asp:ListItem>26. Organ Transplant</asp:ListItem>
				                                       <asp:ListItem>27. Respiratory/Lung Disorder</asp:ListItem>
				                                       <asp:ListItem>28. Skin Disorder</asp:ListItem>
				                                       <asp:ListItem>29. Stroke/Nervous System/Brain Disorder</asp:ListItem>
				                                       <asp:ListItem>30. Tumor</asp:ListItem>
				                                       <asp:ListItem>31. Tobacco Product Use</asp:ListItem>
				                                       <asp:ListItem>32. Vascular (blood vessel) Disorder</asp:ListItem>
			                                       </asp:CheckBoxList>
		                                       </td>
	                                       </tr>
	                                       <tr id="trDueDate">
                                       ...
                                       <table style="width: 717px; margin-left: 40px; margin-top: 4px;" 
	                                       ...
	                                       <tr>
		                                       ...
		                                       <td class="style9" valign="top">
			                                       <asp:Label ID="Label96" runat="server" Text="Have you or any person named in this application received inpatient or outpatient services in the last three (3) years (excluding routine tests, physicals or innoculations)?"></asp:Label>
		                                       </td>
	                                       </tr>
	                                       <tr>
                                ...
                                <asp:WizardStep ID="WizardStep12" title="Health Explanations" runat="server">
                                    <!--Start Health Explanations-->
                                       ...
                                       <tr>
	                                       <td>
		                                       <asp:Label ID="Label100" runat="server" CssClass="tableTitle" Text="Section 3 - Health Statments"></asp:Label>
	                                       </td>
                                       ...
                                       <tr>
	                                       <td> For any of the "X" or "Yes" responses provided in SECTION 1 and 2, please provide full details in the following table per Question Number.  You can enter explanations by pressing the 'add' button below.</td>
	                                       <td>
		                                       &nbsp;</td>
	                                       <td>
		                                       &nbsp;</td>
                                    ...
                                    <asp:LinkButton ID="btnAdd" runat="server" OnClick="btnAdd_Click" Text="Add" CausesValidation = "false"></asp:LinkButton>
                                    <asp:GridView ID="GridView1" runat="server" DataSourceID="ObjectDataSource1" 
                                        ...
                                        <Columns>
                                            <asp:CommandField ShowDeleteButton="true" SelectText="Edit" ShowSelectButton="true" />
                                            <asp:BoundField DataField="Question" HeaderText="Question" 
                                                SortExpression="Question" />
                                                
                                            <asp:BoundField DataField="Name" HeaderText="Person Name" SortExpression="Name" />
                                            <asp:BoundField DataField="Condition" HeaderText="Name of Condition" 
                                    ...
                                    <asp:Panel ID="pnlPopup" runat="server" CssClass="detailsgrid" Width="600px" >
                                        ...
                                        <table border="0" width="100%" cellpadding="2px" class="detail">
                                            <tr>
                                                <td width="30%"><asp:Label ID="Label101" runat="server" CssClass="labelRight" Text="Question"></asp:Label></td>
                                                <td width="70%"><asp:DropDownList runat="server" ID="cmbQuestion" Height="22px" 
                                                        Width="181px"></asp:DropDownList>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Please Select a Question" ControlToValidate="cmbQuestion"></asp:RequiredFieldValidator></td>
                                            </tr>
                                            
                                            <tr>
                                                <td width="30%"><asp:Label ID="Label102" runat="server" CssClass="labelRight" Text="Person"></asp:Label></td>
                                                <td width="70%"><asp:DropDownList runat="server" ID="cmbPersonName" Height="22px" 
                                                        Width="181px"></asp:DropDownList></td>
                                            </tr>
                                            
                                            <tr>
                                                <td width="30%"><asp:Label ID="Label103" runat="server" CssClass="labelRight" Text="Name of Condition"></asp:Label></td>
                                                <td width="70%"><asp:TextBox ID="txtCondition" runat="server" Width="181px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtCondition"  ErrorMessage=" Condition is Required" Display="Static" SetFocusOnError="true"  /></td>
                            
                                            </tr>
                                            
                                            <tr>
                                                <td width="30%"><asp:Label ID="Label104" runat="server" CssClass="labelRight" Text="Date Diagnosed"></asp:Label></td>
                                                <td width="70%"><asp:TextBox ID="txtDateDiagnosed" runat="server" Height="21px" 
                                                        Width="181px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtDateDiagnosed"  ErrorMessage=" Date Diagnosed is Required" Display="Static" SetFocusOnError="true"  /></td>
                                            </tr>
                                            
                                            <tr>
                                                <td width="30%"><asp:Label ID="Label105" runat="server" CssClass="labelRight" Text="Date Last Treated"></asp:Label></td>
                                                <td width="70%"><asp:TextBox ID="txtDateLastTreated" runat="server" Width="181px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtDateLastTreated"  ErrorMessage=" Date Treated is Required" Display="Static" SetFocusOnError="true"  /></td>
                                            </tr>
                                            
                                            <tr>
                                                <td width="30%"><asp:Label ID="Label106" runat="server" CssClass="labelRight" 
                                                        Text="Treatment Type / Medications" Height="22px"></asp:Label></td>
                                                <td width="70%"><asp:TextBox Height="5em" Rows="4" ID="txtMeds" runat="server" 
                                                        TextMode="MultiLine" Width="181px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtMeds"  ErrorMessage=" Medications is required" Display="Static" SetFocusOnError="true"  /></td>
                                            </tr>
                                            
                                            <tr>
                                                <td width="30%"><asp:Label ID="Label107" runat="server" CssClass="labelRight" Text="Medication ongoing?"></asp:Label></td>
                                                <td width="70%"><asp:CheckBox ID="chkOngoing" runat="server" Text="Yes" /></td>
                                            </tr>
                                            
                                            <tr>
                                                <td width="30%"><asp:Label ID="Label108" runat="server" CssClass="labelRight" Text="Degree of Recovery"></asp:Label></td>
                                                <td width="70%"><asp:TextBox ID="txtDegreeOfRecovery" runat="server" Width="181px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtDegreeOfRecovery"  ErrorMessage=" Degree of Recovery is Required" Display="Static" SetFocusOnError="true"  /></td>
                                            </tr>
                                        ...
                                        <asp:LinkButton ID="btnClose" Text="Cancel" runat="server" CausesValidation="False" />
                                        <asp:LinkButton ID="btnSave" Text="Save" OnClick="btnSave_Click" runat="server" CausesValidation="true"/>
                                    </asp:Panel>
                                ...
                                <asp:WizardStep ID="WizardStep13" title="Processing Application" runat="server">
                                <!--Start Processing-->
                                    <style type="text/css">
                                    .style4
                                    {
                                ...
                                <asp:WizardStep ID="WizardStep14" title="Review Application" runat="server" 
                                    StepType="Finish">
                                <!--Start Review-->
                                    <style type="text/css">
	                                    #frame1
                                    ...
                                    <p>Press next to proceed with signing your application. </p>
                                    <p><a href="https://ienroll.ociservices.com/NebraskaApp/preview.aspx" target="_blank">Click Here</a> To download application for your records.</p>

                                    <asp:Button ID="Button1" runat="server" Height="28px"                              
                                        style="margin-top: 0px; margin-bottom: 13px; float:right; margin-right: 20px; margin-left: 11px;" 
                                        Text="Next" class="buttons"  
                                        OnClick="Button1_Click" />
                                                                            <asp:Button ID="Button2" runat="server" Height="28px"                              
                                        style="margin-top: 0px; margin-bottom: 13px; float:right; margin-right: 50px; margin-left: 11px;" 
                                        Text="Previous" class="buttons"  
                                        OnClick="Button2_Click" />
                                    <br />
                                    <div style="clear:both;"></div>
                          
                                    <object data="https://ienroll.ociservices.com/NebraskaApp/preview.aspx" type="application/pdf" width="750px" height="800px">
                                            alt : <a href="https://ienroll.ociservices.com/NebraskaApp/preview.aspx" target="_blank">Click Here to View Application</a>
                                    </object>
