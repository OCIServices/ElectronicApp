<%@ Page Language="C#" Theme="FormPage" AutoEventWireup="true" CodeBehind="EditClient.aspx.cs" Inherits="ElectronicApp.BrokerAdmin.EditClient" %>
           ...
           <h2><p><span class="red">Your Contact Card</span></p></h2>
               ...
               <table style="width: 100%; margin-left: 31px; margin-bottom: 0px;">
                   <tr>
                       ...
                       <td id="Td1" class="style7" runat="server">
                           <asp:TextBox ID="BrokerFirstName" MaxLength="50" runat="server" Width="250px"></asp:TextBox>
                           </td>
                   </tr>
                   <tr>
                       <td class="style8">
                           <asp:label ID="Label2" CssClass="labelRight" runat="server" Text="Tax ID:"></asp:label></td>
                       <td id="Td2" class="style7" runat="server">
                           <asp:TextBox ID="TaxID" MaxLength="100" runat="server" Width="250px"></asp:TextBox></td>
                   </tr>
                   <tr>
                       <td class="style4">
                           <asp:label ID="Label1" CssClass="labelRight" runat="server" Text="Phone:"></asp:label>
                       </td>
                       <td id="Td3" class="style7" runat="server">
                           <asp:TextBox ID="BrokerPhone" MaxLength="15" runat="server" Width="250px"></asp:TextBox></td>
                   </tr>
                   <tr>
                       <td class="style5"><asp:label ID="Label5" CssClass="labelRight" runat="server" Text="Fax:"></asp:label></td>
                       <td id="Td4" class="style2" runat="server">
                           <asp:TextBox ID="BrokerFax" MaxLength="15" runat="server" Width="250px"></asp:TextBox></td>
                   </tr>
                   <tr>
                       ...
                       <td id="Td5" class="style3" runat="server">
                           <asp:TextBox ID="BrokerAddress" MaxLength="50" runat="server" Width="250px"></asp:TextBox></td>
                   </tr>
                   <tr>
                       ...
                       <td id="Td6" class="style3" runat="server">
                           <asp:TextBox ID="BrokerCity" MaxLength="50" runat="server" Width="250px"></asp:TextBox></td>
                   </tr>
                   <tr>
                       ...
                       <td id="Td7" class="style3" runat="server">
                           <asp:TextBox ID="BrokerState" MaxLength="2" runat="server" Width="250px"></asp:TextBox></td>
                   </tr>
                   <tr>
                       <td class="style6"><asp:label ID="Label9" CssClass="labelRight" runat="server" Text = "Zip:"></asp:label></td>
                       <td id="Td8" class="style3" runat="server">
                           <asp:TextBox ID="BrokerZip" MaxLength="5" runat="server" Width="250px"></asp:TextBox></td>
                   </tr>
               </table>
               <br />
               <br />
